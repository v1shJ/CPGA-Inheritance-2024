...
export default function Example() {
  ...
  return (
    <Disclosure as="nav" className="border rounded-lg border-cyan-300 fixed w-full backdrop-blur-sm z-10">
            ...
            {/* Mobile menu button */}
                  ...
                  <div className="hidden sm:ml-6 sm:block">
                    ...
                    {navigation.map((item) => (
                      ...
                      className={({ isActive }) =>
                        classNames(
                        isActive ? 'custom-btn' : 'text-gray-300 hover:bg-cyan-50 hover:text-black',
            ...
            <Menu as="div" className="relative">
              <div>
                <MenuButton className="relative flex rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                  ...
                  <img
                    alt=""
                    src={image ? `${backendUrl}/images/uploads/${image}` : `${backendUrl}/images/uploads/default.jpg`}
