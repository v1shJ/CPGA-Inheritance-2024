...
import profileImage from '../assets/LandingPageImage.png'

const navigation = [
  { name: 'Home', to: '/home', current: true },
  { name: 'About', to: '/about', current: false },
  { name: 'Discussion', to: '/discussion', current: false },
  { name: 'ChatBot', to: '/chatBot', current: false },
]
...
export default function Example() {
  return (
    <Disclosure as="nav" className="border fixed w-full backdrop-blur-sm z-10">
